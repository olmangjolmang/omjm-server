    ...
    public void run(ApplicationArguments args) throws Exception {
        if (postRepository.count() > 0) {
            ...
            Post post1 = Post.builder()
                    ...
                    .author("전반숙")
                    .createdDate(LocalDate.parse("2024-07-06"))
            ...
            Post post2 = Post.builder()
                    ...
                    .author("osohyun0224")
                    .createdDate(LocalDate.parse("2024-07-15"))
            ...
            Post post3 = Post.builder()
                    ...
                    .author("김형섭 (Matthew)")
                    .createdDate(LocalDate.parse("2024-06-05"))
            ...
            Post post4 = Post.builder()
                    ...
                    .author("MINJEE")
                    .createdDate(LocalDate.parse("2023-12-09"))
                    .category(Category.WEB_FRONT)
                    .image(S3Info.builder()
            ...
            Post post5 = Post.builder()
                    ...
                    .author("workee")
                    .createdDate(LocalDate.parse("2024-06-02"))
                    .category(Category.WEB_FRONT)
                    .image(S3Info.builder()
            ...
            Post post6 = Post.builder()
                    ...
                    .author("Eden")
                    .createdDate(LocalDate.parse("2023-01-20"))
                    .category(Category.WEB_FRONT)
                    .image(S3Info.builder()
            ...
            Post post7 = Post.builder()
                    ...
                    .author("Evan Moon")
                    .createdDate(LocalDate.parse("2023-11-27"))
            ...
            Post post8 = Post.builder()
                    ...
                    .author("골든래빗")
                    .createdDate(LocalDate.parse("2023-05-25"))
                    .category(Category.ETC)
                    .image(S3Info.builder()
            ...
            Post post9 = Post.builder()
                    ...
                    .author("강현석")
                    .createdDate(LocalDate.parse("2023-01-15"))
                    .category(Category.ETC)
                    .image(S3Info.builder()
            ...
            Post post10 = Post.builder()
                    ...
                    .author("City_Duck")
                    .createdDate(LocalDate.parse("2023-03-13"))
                    .category(Category.NETWORK)
                    .image(S3Info.builder()
            ...
            Post post11 = Post.builder()
                    ...
                    .author("지푸라기 개발자")
                    .createdDate(LocalDate.parse("2019-09-03"))
                    .category(Category.NETWORK)
                    .image(S3Info.builder()
            ...
            Post post12 = Post.builder()
                    ...
                    .author("적어야 머리에 남는다!")
                    .createdDate(LocalDate.parse("2021-05-02"))
                    .category(Category.NETWORK)
                    .image(S3Info.builder()
            ...
            Post post13 = Post.builder()
                    ...
                    .author("Terry Cho")
                    .createdDate(LocalDate.parse("2019-01-14"))
            ...
            Post post14 = Post.builder()
                    ...
                    .author("ijnuemik")
                    .createdDate(LocalDate.parse("2020-10-10"))
                    .category(Category.INFRA)
                    .image(S3Info.builder()
            ...
            Post post15 = Post.builder()
                    ...
                    .author("wlsdn3004")
                    .createdDate(LocalDate.parse("2023-05-12"))
                    .category(Category.INFRA)
                    .image(S3Info.builder()
            ...
            Post post16 = Post.builder()
                    ...
                    .createdDate(LocalDate.parse("2024-02-05"))
            ...
            Post post17 = Post.builder()
                    ...
                    .author("퀄컴 코리아")
                    .createdDate(LocalDate.parse("2024-02-01"))
                    .category(Category.AI)
                    .image(S3Info.builder()
            ...
            Post post19 = Post.builder()
                    ...
                    .author("김지수")
                    .createdDate(LocalDate.parse("2024-05-01"))
                    .category(Category.AI)
                    .image(S3Info.builder()
            ...
            Post post20 = Post.builder()
                    ...
                    .author("아야옹이다")
                    .createdDate(LocalDate.parse("2024-05-25"))
                    .category(Category.AI)
                    .image(S3Info.builder()
            ...
            Post post21 = Post.builder()
                    ...
                    .author("BigPine24")
                    .createdDate(LocalDate.parse("2024-02-29"))
                    .category(Category.AI)
                    .image(S3Info.builder()
            ...
            Post post22 = Post.builder()
                    ...
                    .author("박지민")
                    .createdDate(LocalDate.parse("2024-06-22"))
                    .category(Category.AI)
                    .image(S3Info.builder()
            ...
            Post post23 = Post.builder()
                    ...
                    .author("이승호")
                    .createdDate(LocalDate.parse("2024-06-21"))
            ...
            Post post24 = Post.builder()
                    ...
                    .author("김민준")
                    .createdDate(LocalDate.parse("2024-06-20"))
                    .category(Category.INFRA)
                    .image(S3Info.builder()
            ...
            Post post25 = Post.builder()
                    ...
                    .author("최영희")
                    .createdDate(LocalDate.parse("2024-06-19"))
                    .category(Category.ETC)
                    .image(S3Info.builder()
            ...
            Post post26 = Post.builder()
                    ...
                    .author("이재영")
                    .createdDate(LocalDate.parse("2024-06-18"))
                    .category(Category.BACKEND)
                    .image(S3Info.builder()
            ...
            Post post27 = Post.builder()
                    ...
                    .author("한지우")
                    .createdDate(LocalDate.parse("2024-06-17"))
                    .category(Category.WEB_FRONT)
                    .image(S3Info.builder()
            ...
            Post post28 = Post.builder()
                    ...
                    .author("정영재")
                    .createdDate(LocalDate.parse("2024-06-16"))
                    .category(Category.NETWORK)
                    .image(S3Info.builder()
            ...
            Post post29 = Post.builder()
                    ...
                    .author("이상민")
                    .createdDate(LocalDate.parse("2024-06-15"))
            ...
            Post post30 = Post.builder()
                    ...
                    .author("김현우")
                    .createdDate(LocalDate.parse("2024-06-14"))
